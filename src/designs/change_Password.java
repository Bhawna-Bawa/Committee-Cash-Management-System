...
public class change_Password extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        newC = new javax.swing.JPasswordField();
        ...
        myPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(myPanel1Layout.createSequentialGroup()
                ...
                .addGroup(myPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(newP, javax.swing.GroupLayout.DEFAULT_SIZE, 211, Short.MAX_VALUE)
                    .addComponent(newC))
            ...
            .addGroup(myPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(old, javax.swing.GroupLayout.PREFERRED_SIZE, 211, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        myPanel1Layout.setVerticalGroup(
            ...
            .addGroup(myPanel1Layout.createSequentialGroup()
                ...
                .addGap(19, 19, 19)
                .addGroup(myPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(newC, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(old.getText().trim().length()>0 && newP.getText().trim().length()>0 && newC.getText().trim().length()>0 )
        {
            String s=old.getText();

            EnterDetails e=new EnterDetails();
            if(e.getChangePassword(s, id))
            {
                if(newP.getText().equals(newC.getText()))
                {
                    String n=newP.getText();
                    if(e.updatePassword(n, id))
                    {
    ...
    private javax.swing.JPasswordField newC;
